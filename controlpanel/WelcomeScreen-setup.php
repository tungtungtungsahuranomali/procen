...
<html lang="en">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="reflexology.php"><span class="fa fa-image"></span> Ascott Cares</a>
          </li>
          <li>
      ...
      <div id="content" class="p-4 p-md-5">
       ...
       <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <a class="btn btn-success" href="<?php echo (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . '/images/video/welcome.mp4'; ?>" target="_blank">Preview</a>
        </div>
      </form>
		  </div>
      <?php  
